...
const (
	...
	SmartypantsFractions                          // Enable smart fractions (with HTML_USE_SMARTYPANTS)
	SmartypantsLatexDashes                        // Enable LaTeX-style dashes (with HTML_USE_SMARTYPANTS)
	SmartypantsAngledQuotes                       // Enable angled double quotes (with HTML_USE_SMARTYPANTS) for double quotes rendering
...
// stylesheet.
// title and css are only used when CompletePage is selected.
...
func (options *Html) Table(out *bytes.Buffer, header []byte, body []byte, columnData []TableFlags) {
	doubleSpace(out)
...
func (options *Html) TableHeaderCell(out *bytes.Buffer, text []byte, align TableFlags) {
	doubleSpace(out)
	switch align {
...
func (options *Html) TableCell(out *bytes.Buffer, text []byte, align TableFlags) {
	doubleSpace(out)
	switch align {
	case TableAlignmentLeft:
